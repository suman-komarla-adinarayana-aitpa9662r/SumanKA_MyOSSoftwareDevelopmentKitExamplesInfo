...
boolean toggleLEDsShell(pchar args, void *data, IfxStdIf_DPipe *io)
{
    switch(args[0])
    {
        ...
        case '3': /* Toggle LED3 */
            ...
            IfxStdIf_DPipe_print(io, "Toggled LED3!" ENDLINE ENDLINE);
            break;
        case '4': /* Toggle LED4 */
            IfxPort_setPinState(LED4, IfxPort_State_toggled);
            IfxStdIf_DPipe_print(io, "Toggled LED4!" ENDLINE ENDLINE);
            break;
        default: /* Turn off all LEDs */
            ...
            IfxStdIf_DPipe_print(io, "Command syntax not correct." ENDLINE \
                    "The correct syntax for this command is" ENDLINE "    '" COMMAND_TOGGLE " [0/1/2/3/4]'" ENDLINE \
