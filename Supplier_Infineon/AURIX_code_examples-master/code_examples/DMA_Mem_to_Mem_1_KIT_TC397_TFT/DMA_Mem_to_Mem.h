...
#ifndef DMA_MEM_TO_MEM_H_
#define DMA_MEM_TO_MEM_H_ 1
...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define MEMORY_TRANSFER_NUM_DATA    10                           /* Number of data to transfer                      */
#define NO_FAILURE                  0                            /* No failure value                                */
#define LED_DMA_FAILURE             &MODULE_P13,1                /* LED for DMA failure                             */
#define LED_DMA_SUCCESS             &MODULE_P13,0                /* LED for DMA success                             */
...
/*-----------------------------------------------Function Prototypes-------------------------------------------------*/
/*********************************************************************************************************************/
void initDMA(void); /* Function to initialize the DMA module and the LEDs */
void runDMA(void);  /* Start transfer of data */

#endif /* DMA_MEM_TO_MEM_H_ */
